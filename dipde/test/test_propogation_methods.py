...
def test_singlepop_approx_order_1():
    ...
    approx_order = 1
    simulation = get_singlepop_simulation(dv=dv, update_method=update_method, approx_order=approx_order)
...
def test_singlepop_tol():
    ...
    update_method = 'approx'
    tol = 1e-5
    simulation = get_singlepop_simulation(dv=dv, update_method=update_method, tol=tol)
    simulation.run(dt=dt, tf=tf, t0=t0)
    i1 = simulation.population_list[1]
...
if __name__ == "__main__":          # pragma: no cover
    test_singlepop_approx_order_1() # pragma: no cover
    test_singlepop_approx_order_2() # pragma: no cover
